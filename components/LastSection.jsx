...
const LastSection = () => {
  return (
    <div className="container-fluid mx-auto w-[500px] md:w-full relative">
      <div className='bg-[url("/a127809b20d09f96783f575dbf41f49f.jpg")]  w-full h-[100vh] top-[700px] xl:top-[400px]  bg-cover  bg-no-repeat bg-center flex items-center relative'>
