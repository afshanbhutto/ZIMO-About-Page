...
const EntryTickets = () => {
  return (
    <div className="container mx-auto ">
      <div className=" absolute top-[1700px] md:top-[1700px] lg:mt-[48px] xl:mt-[400px]  flex items-center justify-center lg:justify-normal lg:gap-x-54 flex-col md:flex-row">
        <div className="text-left lg:flex-1 lg:justify-left justify-center items-center ">
          ...
          <div className=" leading-2 mt-5 uppercase tracking-[4px] text-left mb-3">
            <p className="text-2xl  lg:text-[32px] lg:mb-8">one source</p>
            <p className="text-3xl lg:text-[40px] lg:mb-10 mr-24">entry tickets</p>
