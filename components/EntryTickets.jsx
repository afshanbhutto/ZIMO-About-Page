...
const EntryTickets = () => {
  return (
    <div className="container mx-auto ">
      <div className=" absolute top-[1700px] md:top-[1700px] lg:mt-[40px] xl:mt-[400px]  flex items-center justify-center lg:justify-normal lg:gap-x-54 flex-col md:flex-row">
