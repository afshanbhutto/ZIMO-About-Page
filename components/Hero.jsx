...
<div className='bg-[url("/ad08e64c018e38e3d381ca3f8f1ce858.jpg")] h-screen w-[500px] md:w-full m-0 p-0  bg-cover  bg-no-repeat bg-center flex gap-[30%]   flex-col lg:gap-[30%] md:gap-[20%] relative'>
        ...
        <div className="container mx-auto px-4 z-10">
            <div className="flex flex-col text-left text-white gap-[10px] lg:gap-[20px]">
                <div className='tracking-wider leading-8' >
                    <p className='text-xl  lg:text-3xl  tracking-[2px] uppercase'>Discover</p>
                </div>
                <div className='tracking[4px] leading-8' >
                    <h1 className='text-xl  lg:text-5xl uppercase '>A new world</h1>
                </div>
                <div className='tracking-[2px] uppercase leading-7 text-left'>
                    <p className='text-gray-500 text-sm lg:text-xl '>FOR THOSE WHO WISH FOR MORE... </p>
                </div>
            </div>
